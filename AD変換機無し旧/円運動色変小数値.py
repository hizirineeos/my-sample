...
#for row in range(400):
    ...
    pygame.draw.rect(screen, WHITE, (int(x0-8), int(yy), 16, 16))
    pygame.draw.rect(screen, RED, (int(x1), int(y1), 16, 16))
    
    #十字線
    pygame.draw.line(screen,LIGHTBLUE,(int(x0),int(50)),(int(x0),int(950)),1)
    pygame.draw.line(screen,LIGHTBLUE,(int(450),int(yy+8)),(int(1350),int(yy+8)),1)
