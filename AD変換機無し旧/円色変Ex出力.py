...
sheet.tittle = "round"
i = 2
sheet.cell(row = i, column = 2).value = dt.datetime.now()
...
#for row in range(400):
    ...
    #Excelのセルに入力
    sheet.cell(row = i, column = 3).value = X_BALL
    sheet.cell(row = i, column = 4).value = Y_BALL
    sheet.cell(row = i, column = 5).value = xm
    sheet.cell(row = i, column = 6).value = ym
    sheet.cell(row = i, column = 7).value = mBd
    i += 1
